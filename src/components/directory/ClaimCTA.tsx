...
export default function ClaimCTA({ farmName, farmSlug }: ClaimCTAProps) {
  return (
    <div className="bg-gradient-to-r from-green-50 to-orange-50 border-2 border-green-200 rounded-xl p-6 md:p-8">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-600 mb-4">
            We featured <span className="font-medium text-green-700">{farmName}</span> because
