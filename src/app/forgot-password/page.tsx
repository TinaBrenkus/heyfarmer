      ...
      <div className="min-h-screen flex items-center justify-center" style={{ background: 'linear-gradient(to bottom right, #F0EDE4, #FAF7F0, #F0EDE4)' }}>
        <div className="w-full max-w-md mx-4">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="text-sm text-soil-400 text-center mb-6">
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                className="w-full py-3 px-4 border border-warm-border rounded-lg font-semibold text-soil-700 hover:bg-soil-50 transition-colors"
              >
                Try Different Email
              </button>
