      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          <div className="text-center mb-8">
            ...
            <div className="bg-farm-green-50 border border-warm-border rounded-lg p-4 inline-block">
              <p className="text-farm-green-900 font-semibold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="text-center p-6 bg-terra-50 rounded-lg border border-terra-200">
              <Mail className="w-8 h-8 text-terra-600 mx-auto mb-3" />
              <h3 className="font-semibold text-soil-800 mb-2">Email Support</h3>
              <p className="text-soil-500 mb-3">Get help with your account, listings, or general questions</p>
              <a 
                href="mailto:admin@heyfarmer.farm" 
                className="inline-flex items-center gap-2 text-terra-600 hover:text-terra-700 font-semibold"
              >
            ...
            <div className="text-center p-6 bg-terra-50 rounded-lg border border-terra-200">
              <Users className="w-8 h-8 text-terra-600 mx-auto mb-3" />
              <h3 className="font-semibold text-soil-800 mb-2">Farmer Support</h3>
              <p className="text-soil-500 mb-3">Dedicated assistance for farmers joining our platform</p>
              <a 
                href="mailto:admin@heyfarmer.farm" 
                className="inline-flex items-center gap-2 text-terra-600 hover:text-terra-700 font-semibold"
              >
          ...
          {/* Office Hours */}
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 text-soil-500 mb-2">
        ...
        {/* Common Questions */}
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          <h2 className="text-2xl font-bold text-soil-800 mb-6 text-center">
            Frequently Asked Questions
          </h2>
          
          <div className="space-y-6">
            <div className="border-l-4 border-farm-green-500 pl-4">
              <h3 className="font-semibold text-soil-800 mb-2">How do I get started selling on Hey Farmer?</h3>
              <p className="text-soil-700">
                <Link href="/signup" className="text-farm-green-800 hover:text-farm-green-800 underline">Sign up</Link> for 
            ...
            <div className="border-l-4 border-orange-500 pl-4">
              <h3 className="font-semibold text-soil-800 mb-2">Which areas does Hey Farmer serve?</h3>
              <p className="text-soil-700">
                ...
                <a href="mailto:weareheyfarmer@gmail.com" className="text-terra-600 hover:text-terra-700 underline"> contact us</a> 
                about future expansion.
              </p>
            </div>

            <div className="border-l-4 border-farm-green-500 pl-4">
              <h3 className="font-semibold text-soil-800 mb-2">How do payments work?</h3>
              <p className="text-soil-700">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <div className="text-center">
            <div className="inline-flex items-center gap-2 text-soil-500 mb-4">
        ...
        <div className="bg-gradient-to-r from-farm-green-800 to-farm-green-900 rounded-lg shadow-lg p-8 text-white text-center mb-8">
