    ...
    <div className="min-h-screen bg-soil-50 pb-20 md:pb-0">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 prose prose-lg max-w-none">
          ...
          <h2 className="text-xl font-semibold text-soil-800 mt-8 mb-4">1. Acceptance of Terms</h2>
          ...
          <h2 className="text-xl font-semibold text-soil-800 mt-8 mb-4">2. Platform Description</h2>
          <p className="text-soil-700 mb-4">
          ...
          <h2 className="text-xl font-semibold text-soil-800 mt-8 mb-4">3. User Responsibilities</h2>
          <div className="text-soil-700 mb-4 space-y-2">
          ...
          <h2 className="text-xl font-semibold text-soil-800 mt-8 mb-4">4. Marketplace Transactions</h2>
          <p className="text-soil-700 mb-4">
          ...
          <h2 className="text-xl font-semibold text-soil-800 mt-8 mb-4">5. Content Guidelines</h2>
          <p className="text-soil-700 mb-4">
          ...
          <h2 className="text-xl font-semibold text-soil-800 mt-8 mb-4">6. Privacy</h2>
          <p className="text-soil-700 mb-4">
            Your use of Hey Farmer is also governed by our <Link href="/privacy" className="text-farm-green-800 hover:text-farm-green-800 underline">Privacy Policy</Link>, 
            which describes how we collect, use, and protect your information.
          </p>

          <h2 className="text-xl font-semibold text-soil-800 mt-8 mb-4">7. Limitation of Liability</h2>
          <p className="text-soil-700 mb-4">
          ...
          <h2 className="text-xl font-semibold text-soil-800 mt-8 mb-4">8. Account Termination</h2>
          <p className="text-soil-700 mb-4">
            We reserve the right to suspend or terminate accounts that violate these terms or engage in 
            fraudulent or harmful behavior.
          </p>

          <h2 className="text-xl font-semibold text-soil-800 mt-8 mb-4">9. Changes to Terms</h2>
          <p className="text-soil-700 mb-4">
            We may update these Terms of Service from time to time. Continued use of Hey Farmer after 
            changes constitutes acceptance of the new terms.
          </p>

          <h2 className="text-xl font-semibold text-soil-800 mt-8 mb-4">10. Contact Information</h2>
          <p className="text-soil-700 mb-4">
            For questions about these Terms of Service, please <Link href="/contact" className="text-farm-green-800 hover:text-farm-green-800 underline">contact us</Link>.
          </p>
