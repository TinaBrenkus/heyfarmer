    ...
    <div className="min-h-screen bg-gray-50 pb-20 md:pb-0">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
          <Link href="/directory" className="hover:text-green-600 transition-colors">
            Farm Directory
          </Link>
          <span>/</span>
          <Link href={`/${countySlug}`} className="hover:text-green-600 transition-colors">
            {countyName}
          </Link>
          <span>/</span>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 md:p-8 mb-6">
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            <div>
              ...
              {farm.tagline && (
                <p className="text-lg text-gray-600 mb-3">{farm.tagline}</p>
              )}
        ...
        {farm.description && (
          <div className="bg-white rounded-xl shadow-sm p-6 md:p-8 mb-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">About {farm.name}</h2>
        ...
        {farm.products.length > 0 && (
          <div className="bg-white rounded-xl shadow-sm p-6 md:p-8 mb-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">What They Grow</h2>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 md:p-8 mb-6">
            ...
            <div className="space-y-3">
              ...
              {farm.facebook_url && (
                ...
                >
                  <svg className="w-[18px] h-[18px] text-gray-400" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                  <span>Facebook</span>
                  <ExternalLink size={14} className="text-gray-400" />
                </a>
              )}
        ...
        <div className="text-center">
          <Link
            href="/directory"
            className="inline-flex items-center gap-2 text-gray-500 hover:text-green-600 transition-colors text-sm"
          >
            <ChevronLeft size={16} />
